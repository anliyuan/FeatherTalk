c++流式推理在这了，如果大家有将这个项目部署到移动端的需求，需要自己去搞各端的代码，接进去就可以了。按照我自己的测试，当前这个项目跑在中端及以上的移动端设备上肯定是没问题了。音频编码器已经快的飞起了，后续我的优化重点会放在unet上了。目前还有一些提速的小方法，大概还能将unet提速个百分之二三十，我还在测，后续也会开源到这个项目。欢迎大家试用，star，issue。以下是codex帮我写的⬇️。
